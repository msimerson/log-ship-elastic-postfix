...
var parser = exports.parser = require(cfg.parser.module);

exports.parseLine = function (line, lineCount) {

  var sys = parser.asObjectType('syslog', line);
  if (!sys || !sys.prog) {
  ...
  var parsed = parser.asObjectType(sys.prog, sys.msg);
  if (!parsed) {
...
exports.addToPostfixDocSuper = function (doc, lo) {
  if (lo.msg === 'removed') {
    doc.isFinal = true;
  }
